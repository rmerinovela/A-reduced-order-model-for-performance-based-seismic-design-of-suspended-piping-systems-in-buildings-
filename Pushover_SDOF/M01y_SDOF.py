...
mass = [6.32, 6.32, 0] 
Gamma = 0.891
DispShape = [0.829,1.014,1.03,1.16,1.15,1.0]
nT = 5
nL = 3
...
matTot = 1000
op.uniaxialMaterial('Parallel', matTot, matLong, matTran[0], matTran[1],matTran[2],matTran[3],matTran[4])
