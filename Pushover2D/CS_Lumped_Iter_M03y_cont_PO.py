...
#x_stiff_user = np.array([1000.0, 13000.0, 22000.0, 34000.0])
...
# ------------------------------------------------------------
x_ortho_user         = np.array([36000])
L_ortho_user         = np.array([18000])
n_ortho_pipes_user   = np.array([3])
n_ortho_springs_user = np.array([1])
