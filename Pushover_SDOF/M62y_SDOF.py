...
mass = [20, 20, 0] 
Gamma = 0.69
DispShape = [0.44,0.71,1.00,1.15,1.7,2.13,1.8,1.32,1]
nT = 8
nL = 10
...
matLong = 10
matTran = [20,30,40,50,60,70,80,90]
...
matTot = 1000
op.uniaxialMaterial('Parallel', matTot, matLong, matTran[0], matTran[1],matTran[2],matTran[3],matTran[4],matTran[5],matTran[6],matTran[7])
