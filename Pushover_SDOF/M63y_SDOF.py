...
mass = [21.12, 21.12, 0] 
Gamma = 1.102
DispShape = [0.31,0.48,0.56,0.66,0.87,1.00,1.05,1]
nT = 7
nL = 8
...
matTot = 1000
op.uniaxialMaterial('Parallel', matTot, matLong, matTran[0], matTran[1],matTran[2],matTran[3],matTran[4],matTran[5],matTran[6])
