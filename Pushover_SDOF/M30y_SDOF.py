...
mass = [12.82, 12.82, 0] 
Gamma = 1.055
DispShape = [0.973,0.93,1.04,0.77,0.95,0.92,0.91,0.96,0.99,0.95,0.77,0.92,0.97,0.95,1.1,0.98,0.92,0.98]
nT = 3
nL = 15
...
op.uniaxialMaterial('Parallel', matTot, matLong[0], matLong[1], matLong[2], matLong[3], matLong[4], matLong[5], matLong[6], matLong[7], matLong[8],
                    matLong[9], matLong[10], matLong[11], matLong[12], matLong[13], matLong[14], matTran[0], matTran[1],matTran[2])
