...
mass = [22.36, 22.36, 0] 
Gamma = 0.915
DispShape = [1.05,1.16,1.24,1.26,1.24,1.18,1]
nT = 6
nL = 9
...
matTot = 1000
op.uniaxialMaterial('Parallel', matTot, matLong, matTran[0], matTran[1], matTran[2], matTran[3], matTran[4], matTran[5])
