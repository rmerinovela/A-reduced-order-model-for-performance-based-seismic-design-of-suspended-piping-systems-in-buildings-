...
mass = [12.39, 12.39, 0] 
Gamma = 1.38
DispShape = [0.751,0.67,0.52,0.55,0.67,0.71,0.72,1.0,0.52,0.55,0.69,0.71,0.81,1.0,0.55,0.71,1.0]
nT = 2
nL = 15
...
op.uniaxialMaterial('Parallel', matTot, matLong[0], matLong[1], matLong[2], matLong[3], matLong[4], matLong[5], matLong[6], matLong[7], matLong[8],
                    matLong[9], matLong[10], matLong[11], matLong[12], matLong[13], matLong[14], matTran[0], matTran[1])
