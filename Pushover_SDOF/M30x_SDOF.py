...
matLong = 10
matTran = [20,30,40,50,60,70,80,90,100,110,120,130,140,150,160]
...
matTot = 1000
op.uniaxialMaterial('Parallel', matTot, matLong, matTran[0], matTran[1], matTran[2], matTran[3],matTran[4],matTran[5],matTran[6],matTran[7],matTran[8],matTran[9],matTran[10],matTran[11],matTran[12],matTran[13],matTran[14])
